...
object AuditCoding {
    ...
    // La chaîne reste à SIX champs (contrat cross-plateforme, décodé par index) et
    // transporte l'ÉCHELLE PURE : l'HOMOTHÉTIE est un réglage LOCAL, jamais fondue
    // dans `scale` (règle canonique, alignée sur iOS). Rejouer une entrée du
    // journal ne redimensionne donc pas le plan de celui qui l'annule.
